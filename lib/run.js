...
function decrypt_key(deploy_key, enc_rsa_key_pth, options, auth_sock) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    if (auth_sock === null || auth_sock === undefined) {
      auth_sock = '/tmp/ssh-auth.sock'
    }

    const authSock = auth_sock
...
function run() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const auth_sock = core.getInput('auth_sock');
    ...
    yield decrypt_key(deploy_key, enc_rsa_key_pth, options, auth_sock);
